...
/** ~1 MB binary as base64 data-URL (+ header) */
export const PHOTO_DATA_URL_MAX_CHARS = 1_400_000
export const AVATAR_MAX_CHARS = 1_400_000
...
/** Reject oversized JSON bodies before parsing into memory */
export const HTTP_BODY_MAX_BYTES = 2 * 1024 * 1024
